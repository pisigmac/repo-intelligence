...
- [x] **Step 1: Add CORS middleware to gateway**
...
- [x] **Step 2: Add missing service env vars to gateway in docker-compose.yml**
...
- [x] **Step 4: Restart gateway to pick up changes**
...
- [x] **Step 2: Add nginx service to docker-compose.yml**
...
- [x] **Step 2: Write ui/tsconfig.json**
...
- [x] **Step 3: Write ui/tsconfig.node.json**
...
- [x] **Step 4: Write ui/vite.config.ts**
...
- [x] **Step 5: Write ui/tailwind.config.js**
...
- [x] **Step 6: Write ui/postcss.config.js**
...
- [x] **Step 8: Write ui/src/main.tsx**
...
- [x] **Step 9: Write ui/src/App.tsx (placeholder)**
...
- [x] **Step 10: Write ui/src/index.css**
...
- [x] **Step 11: Create placeholder favicon**
...
- [x] **Step 12: Install dependencies and run dev server**
...
- [x] **Step 1: Write ui/src/types/index.ts**
...
- [x] **Step 2: Write ui/src/api/client.ts**
...
- [x] **Step 3: Write ui/src/utils/formatters.ts**
...
- [x] **Step 1: Write ui/src/store/uiStore.ts**
...
- [x] **Step 2: Write ui/src/components/Sidebar.tsx**
...
- [x] **Step 3: Write ui/src/components/Layout.tsx**
...
- [x] **Step 4: Write ui/src/components/StatusBadge.tsx**
...
- [x] **Step 5: Write ui/src/components/LoadingState.tsx**
...
- [x] **Step 6: Write ui/src/components/ErrorState.tsx**
...
- [x] **Step 7: Write ui/src/components/JsonView.tsx**
...
- [x] **Step 8: Update ui/src/App.tsx to include all routes**
...
- [x] **Step 9: Create empty page files so the build passes**
...
- [x] **Step 10: Run dev server and verify navigation**
...
- [x] **Step 1: Write ui/src/hooks/useRepos.ts**
...
- [x] **Step 2: Write ui/src/hooks/useCapabilities.ts**
...
- [x] **Step 3: Write ui/src/hooks/usePlaybooks.ts**
...
- [x] **Step 4: Write ui/src/hooks/useQuerySearch.ts**
...
- [x] **Step 5: Write ui/src/hooks/useApprovals.ts**
...
- [x] **Step 6: Write ui/src/hooks/useWebSocket.ts**
...
- [x] **Step 1: Replace Dashboard.tsx**
...
- [x] **Step 2: Verify dashboard shows counts**
...
- [x] **Step 1: Replace ui/src/pages/Repos.tsx**
...
- [x] **Step 2: Replace ui/src/pages/RepoDetail.tsx**
...
- [x] **Step 1: Replace ui/src/pages/Capabilities.tsx**
...
- [x] **Step 2: Replace ui/src/pages/CapabilityDetail.tsx**
...
- [x] **Step 1: Replace ui/src/pages/Playbooks.tsx**
...
- [x] **Step 2: Replace ui/src/pages/PlaybookDetail.tsx**
...
- [x] **Step 1: Replace ui/src/pages/Query.tsx**
...
- [x] **Step 2: Replace ui/src/pages/Execute.tsx**
...
- [x] **Step 3: Replace ui/src/pages/Agents.tsx**
...
- [x] **Step 4: Verify each page loads without errors**
...
- [x] **Step 1: Replace ui/src/pages/Approvals.tsx**
...
- [x] **Step 2: Replace ui/src/pages/ApprovalDetail.tsx**
...
- [x] **Step 3: Replace ui/src/pages/Feedback.tsx**
...
- [x] **Step 1: Replace ui/src/pages/Knowledge.tsx**
...
- [x] **Step 2: Write ui/tests/smoke.spec.ts**
...
- [x] **Step 3: Run smoke test against dev server**
...
- [x] **Step 2: Start the full stack including nginx**
